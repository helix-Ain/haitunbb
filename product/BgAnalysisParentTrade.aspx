<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BgAnalysisParentTrade.aspx.cs" Inherits="Digicloud.DAM.Web.CI.Mobile.BgAnalysisParentTrade" %>
		...
		<ion-content class='has-tabs-top'>
			<ion-list>
				<ion-item style='text-align: center;padding-bottom: 25px;'>
					...
					<span style='position:absolute;bottom:1%;left:37%;color:#9F9F9F;font-size:15px;font-weight: 500;'>家长行业分布图</span>
				</ion-item>
				<ion-item style='height:12px;padding: 0;background-color: #E2EEF6;border:none;'></ion-item>
				<ion-item><span class='th'>行业</span><span class='th'>人数</span></ion-item>
				<ion-item><span class='td tdf'><div style='background-color:#A9D86E;' class='radius'></div>未填写</span><span class='td'>4</span></ion-item>
				<ion-item><span class='td tdf'><div style='background-color:#F9A415;' class='radius'></div>金融行业</span><span class='td'>1</span></ion-item>
				<ion-item><span class='td tdf'><div style='background-color:#57C749;' class='radius'></div>教育行业</span><span class='td'>2</span></ion-item>
				<ion-item><span class='td tdf'><div style='background-color:#FEE15D;' class='radius'></div>公务员</span><span class='td'>5</span></ion-item>
				<ion-item><span class='td tdf'><div style='background-color:#F77568;' class='radius'></div>个体户</span><span class='td'>2</span></ion-item>
				<ion-item><span class='td tdf'><div style='background-color:#AB79FB;' class='radius'></div>工人</span><span class='td'>6</span></ion-item>
				<ion-item><span class='td tdf'><div style='background-color:#398EFE;' class='radius'></div>高薪技术人员</span><span class='td'>1</span></ion-item>
				<ion-item><span class='td tdf'><div style='background-color:#F74849;' class='radius'></div>务农</span><span class='td'>1</span></ion-item>
				<ion-item style='height:12px;padding: 0;background-color: #E2EEF6;border:none;'></ion-item>
			</ion-list>
		</ion-content>
		<script>
